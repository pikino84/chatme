<x-app-layout>
    ...
    function renderMessage(msg) {
        ...
        if (hasMedia) {
            ...
            if (msg.body && !isMediaPlaceholder(msg.body)) {
                bodyHtml += '<p class="mt-1 text-xs opacity-70">' + linkify(esc(msg.body)) + '</p>';
            }
    ...
    function updateMessageMedia(msgId, msg) {
        ...
        if (msg.body && !isMediaPlaceholder(msg.body)) {
            mediaHtml += '<p class="mt-1 text-xs opacity-70">' + linkify(esc(msg.body)) + '</p>';
        }
        var time = msg.time || '';
