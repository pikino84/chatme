                ...
                <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                    @php
                        $links = [
                            ...
                            ['route' => 'whatsapp-directo.index', 'match' => 'whatsapp-directo.*', 'label' => 'WhatsApp Directo', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.86 9.86 0 01-4-.8L3 21l1.8-4A7.86 7.86 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/>'],
                            ...
                            ['route' => 'whatsapp-templates.index', 'match' => 'whatsapp-templates.*', 'label' => 'Plantillas', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>'],
