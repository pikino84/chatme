<x-app-layout>
    <div class="max-w-4xl mx-auto py-8 px-4">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Categorías KB</h2>
        ...
        @can('kb.create')
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 mb-6">
                <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Nueva Categoría</h3>
                <form action="{{ route('kb.categories.store') }}" method="POST" class="flex flex-wrap gap-3 items-end">
                    ...
                    <div class="w-20">
                        <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Posición</label>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            <table class="w-full text-sm">
                <thead class="bg-gray-50 dark:bg-gray-700 text-left">
                    <tr>
                        <th class="px-4 py-2 text-gray-500 dark:text-gray-400 font-medium">Nombre</th>
                        <th class="px-4 py-2 text-gray-500 dark:text-gray-400 font-medium">Descripción</th>
                        <th class="px-4 py-2 text-gray-500 dark:text-gray-400 font-medium text-center">Posición</th>
                        <th class="px-4 py-2 text-gray-500 dark:text-gray-400 font-medium text-center">Artículos</th>
                        <th class="px-4 py-2 text-gray-500 dark:text-gray-400 font-medium text-center">Estado</th>
                        <th class="px-4 py-2 text-gray-500 dark:text-gray-400 font-medium text-right">Acciones</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr x-data="{ editing: false }">
                            ...
                            <template x-if="!editing">
                                <td class="px-4 py-3 text-right space-x-2">
                                    @can('update', $cat)
                                        <button @click="editing = true" class="text-xs text-indigo-600 dark:text-indigo-400 hover:underline">Editar</button>
                                    @endcan
                                    @can('delete', $cat)
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-6 text-center text-gray-500 dark:text-gray-400">Sin categorías aún.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
