        ...
        <form action="{{ $article ? route('kb.articles.update', $article) : route('kb.articles.store') }}"
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Contenido <span class="text-xs text-gray-400">(texto plano)</span>
                </label>
            ...
            @if($article)
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Resumen del Cambio</label>
                    <input type="text" name="change_summary" value="{{ old('change_summary') }}" placeholder="¿Qué cambió?"
                           class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200">
                </div>
            @endif

            <fieldset class="border border-gray-200 dark:border-gray-700 rounded-md p-4">
                <legend class="text-sm font-medium text-gray-700 dark:text-gray-300 px-2">Visibilidad por Canal</legend>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('kb.articles') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:underline">Cancelar</a>
            </div>
        </form>
    </div>
</x-app-layout>
