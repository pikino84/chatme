<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto">
        {{-- Welcome --}}
        <div class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Bienvenido, {{ Auth::user()->name }}</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <a href="{{ route('inbox') }}" class="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:border-indigo-500 dark:hover:border-indigo-500 hover:shadow-md transition-all">
                ...
                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">Bandeja</h3>
            ...
            <a href="{{ route('deals.board') }}" class="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:border-emerald-500 dark:hover:border-emerald-500 hover:shadow-md transition-all">
                ...
                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Negocios</h3>
            ...
            <a href="{{ route('kb.articles') }}" class="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:border-amber-500 dark:hover:border-amber-500 hover:shadow-md transition-all">
                ...
                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">Base de Conocimiento</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Art&iacute;culos, categor&iacute;as y config. IA.</p>
            </a>

            @can('settings.update')
            <a href="{{ route('billing.index') }}" class="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:border-violet-500 dark:hover:border-violet-500 hover:shadow-md transition-all">
                ...
                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors">Facturaci&oacute;n</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Suscripci&oacute;n, planes y uso.</p>
            </a>
            ...
            <a href="{{ route('settings.show') }}" class="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:border-gray-500 dark:hover:border-gray-500 hover:shadow-md transition-all">
                ...
                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">Configuraci&oacute;n</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Organizaci&oacute;n, equipo y config. IA.</p>
            </a>
            @endcan
